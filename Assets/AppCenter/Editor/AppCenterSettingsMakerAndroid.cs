...
public class AppCenterSettingsMakerAndroid : IAppCenterSettingsMaker
{
    ...
    private const string DistributeDisableAutomaticCheckForUpdateKey =
    ...
    {
        return File.Exists(AppCenterSettingsContext.AppCenterPath +
                           "/Plugins/Android/appcenter-distribute-release.aar");
    }
