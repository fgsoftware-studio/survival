...
public class PBXProjectWrapper
{
    ...
    private readonly object _pbxProject;
    ...
    public static bool PBXProjectIsAvailable => PBXProjectType != null;
    ...
    public PBXProjectWrapper(string pathToBuiltProject)
    {
        ...
        ProjectPath = PBXProjectType.GetMethod("GetPBXProjectPath", flags)
            .Invoke(PBXProjectType, arguments) as string;
        _pbxProject = PBXProjectType.GetConstructor(Type.EmptyTypes).Invoke(null);
        PBXProjectType.GetMethod("ReadFromFile").Invoke(_pbxProject, new[] {ProjectPath});
    }

    public void WriteToFile()
    {
        PBXProjectType.GetMethod("WriteToFile").Invoke(_pbxProject, new[] {ProjectPath});
    }
...
#endif
    {
        ...
        {
            var frameworkTarget = PBXProjectType.GetMethod("GetUnityFrameworkTargetGuid").Invoke(_pbxProject, null);
