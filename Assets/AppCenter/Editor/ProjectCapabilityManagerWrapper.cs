...
public class ProjectCapabilityManagerWrapper
{
    ...
    private readonly object _capabilityManager;
    ...
    static ProjectCapabilityManagerWrapper()
    {
        ...
        if (xcExtensionsAssembly != null)
            ProjectCapabilityManagerType =
                xcExtensionsAssembly.GetType("UnityEditor.iOS.Xcode.ProjectCapabilityManager");
    }

    public void AddRemoteNotificationsToBackgroundModes()
    {
        var backgroundModesEnumType =
            ProjectCapabilityManagerType.Assembly.GetType("UnityEditor.iOS.Xcode.BackgroundModesOptions");
        var remoteNotifEnum = Enum.Parse(backgroundModesEnumType, "RemoteNotifications");
        ProjectCapabilityManagerType.GetMethod("AddBackgroundModes")
            .Invoke(_capabilityManager, new[] {remoteNotifEnum});
    }

    public static bool ProjectCapabilityManagerIsAvailable => ProjectCapabilityManagerType != null;
