...
public class MaxStorageSizePropertyDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        position.height =
            EditorGUIUtility
                .singleLineHeight; // Though the property may have double height, each child should have half that height.
        property.Next(true);
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
    {
        ...
        if (property.boolValue) height += EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing;
        return height;
    }
}