...
{
    private static readonly string TemplateFilePath =
        AppCenterSettingsContext.AppCenterPath + "/Plugins/iOS/Core/AppCenterStarter.original";

    private static readonly string TargetFilePath =
        AppCenterSettingsContext.AppCenterPath + "/Plugins/iOS/Core/AppCenterStarter.m";
    ...
    private const string DistributeDisableAutomaticCheckForUpdateToken =
    ...
    {
        if (_enableDistributeForDebuggableBuild || !EditorUserBuildSettings.development) AddToken(UseDistributeToken);
    }
