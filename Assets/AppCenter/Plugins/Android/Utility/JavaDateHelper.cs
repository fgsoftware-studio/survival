    ...
    public class JavaDateHelper
    {
        ...
        private static AndroidJavaObject JavaDateFormatter
        {
            get
            {
                ...
                {
                    _javaDateFormatter =
 new AndroidJavaObject("java.text.SimpleDateFormat", "yyyy-MM-dd'T'HH:mm:ss.SSSZ");
                }
        ...
        public static DateTimeOffset DateTimeConvert(AndroidJavaObject date)
        {
            ...
            var dateTime =
 DateTime.ParseExact(dateString, DotNetDateFormat, CultureInfo.InvariantCulture, DateTimeStyles.AdjustToUniversal);
