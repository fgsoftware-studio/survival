...
namespace Microsoft.AppCenter.Unity.Crashes.Internal
{
 ...
 new AndroidJavaClass("com.microsoft.appcenter.crashes.WrapperSdkExceptionManager");
        ...
        {
            var nativeErrorReport =
 _wrapperSdkExceptionManager.CallStatic<AndroidJavaObject>("buildHandledErrorReport", AndroidUtility.GetAndroidContext(), errorReportId);
