...
namespace Microsoft.AppCenter.Unity.Crashes
{
    ...
    public class Crashes
    {
        ...
        private static bool _enableErrorAttachmentsCallbacks;
        private static readonly object _objectLock = new object();

#if !UNITY_WSA_10_0
        private static readonly Queue<Exception> _unhandledExceptions = new Queue<Exception>();
#endif
        ...
        public static void OnHandleLog(string logString, string stackTrace, LogType type)
        {
            if (LogType.Assert == type || LogType.Exception == type || LogType.Error == type)
            {
                ...
                if (_enableErrorAttachmentsCallbacks) SendErrorAttachments(errorReportId);
            }
        }
        ...
        public static void OnHandleUnresolvedException(object sender, UnhandledExceptionEventArgs args)
        {
            ...
            if (exception != null)
            {
                Debug.Log("Unhandled exception: " + exception);
        ...
        /// </summary>
        /// <param name="enabled">
        ///     Specify true to enable reporting of unhandled exceptions, automatically captured by Unity, as
        ///     handled errors; otherwise, false.
        /// </param>
        /// <param name="enableAttachmentsCallback">
        ///     Specify true to enable a callback that gives the app an opportunity to augment
        ///     crash reports with additional attachments.
        /// </param>
        public static void ReportUnhandledExceptions(bool enabled, bool enableAttachmentsCallback = false)
        {
            ...
            if (_reportUnhandledExceptions == enabled) return;
        ...
        {
            set => CrashesInternal.SetUserConfirmationHandler(value);
        }
        ...
        {
            set => CrashesDelegate.SetShouldProcessErrorReportHandler(value);
        }
        ...
        {
            set => CrashesDelegate.SetGetErrorAttachmentsHandler(value);
        }
        ...
        {
            if (_reportUnhandledExceptions) SubscribeToUnhandledExceptions();
        }
        ...
        private static IEnumerator SendUnhandledExceptionReports()
        {
            ...
            while (true)
            {
                ...
                if (exception != null) TrackErrorWithAttachments(exception);
        ...
        private static void TrackErrorWithAttachments(Exception exception)
        {
            ...
            if (_enableErrorAttachmentsCallbacks) SendErrorAttachments(errorId);
        }
        ...
        private static WrapperException CreateWrapperException(string logString, string stackTrace, LogType type)
        {
            ...
            var sanitizedLogString = logString.Replace("\n", " ");
        ...
        private static void SendErrorAttachments(string errorReportId)
        {
            ...
            var attachments = CrashesDelegate.GetErrorAttachmentsHandler == null
                ? null
                : CrashesDelegate.GetErrorAttachmentsHandler(errorReport);
