...
namespace Microsoft.AppCenter.Unity.Internal
{
    ...
    class AppCenterInternal
    {
                                         ...
                                         string liveUpdatePackageHash)
        {
            Prepare();
            var wrapperSdk =
 new Microsoft.AppCenter.WrapperSdk(wrapperSdkName, wrapperSdkVersion, wrapperRuntimeVersion, liveUpdateReleaseLabel, liveUpdateDeploymentKey, liveUpdatePackageHash);
