...
namespace Microsoft.AppCenter.Unity.Internal
{
    class AppCenterInternal
    {
        ...
        public static void Start(string appSecret, Type[] services)
        {
            ...
            var startMethod =
 AndroidJNI.GetStaticMethodID(_appCenter.GetRawClass(), "start", "(Landroid/app/Application;Ljava/lang/String;[Ljava/lang/Class;)V");
        ...
        public static void Start(Type[] services)
        {
            var nativeServiceTypes = ServicesToNativeTypes(services);
            var startMethod =
 AndroidJNI.GetStaticMethodID(_appCenter.GetRawClass(), "start", "(Landroid/app/Application;[Ljava/lang/Class;)V");
            AndroidJNI.CallStaticVoidMethod(_appCenter.GetRawClass(), startMethod, new jvalue[]
            {
                new jvalue { l = GetAndroidApplication().GetRawObject() },
                new jvalue { l = nativeServiceTypes }
        ...
        {
            var startMethod =
 AndroidJNI.GetStaticMethodID(_appCenter.GetRawClass(), "startFromLibrary", "(Landroid/content/Context;[Ljava/lang/Class;)V");
            AndroidJNI.CallStaticVoidMethod(_appCenter.GetRawClass(), startMethod, new jvalue[]
            {
