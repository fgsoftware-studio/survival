...
namespace Microsoft.AppCenter.Unity
{
    ...
    public class AppCenter
    {
        ...
        {
            get => (LogLevel) AppCenterInternal.GetLogLevel();
        ...
        {
            if (_logUrlTask == null) _logUrlTask = new AppCenterTask<string>();
            return _logUrlTask;
        }

        public static AppCenterTask<long> GetStorageSizeAsync()
        {
            if (_storageSizeTask == null) _storageSizeTask = new AppCenterTask<long>();
        ...
        {
            get => AppCenterInternal.IsNetworkRequestsAllowed();
            set => AppCenterInternal.SetNetworkRequestsAllowed(value);
        }

        public static void CacheStorageSize(long storageSize)
        {
            if (_storageSizeTask != null) _storageSizeTask.SetResult(storageSize);
        }

        public static void CacheLogUrl(string logUrl)
        {
            if (_logUrlTask != null) _logUrlTask.SetResult(logUrl);
        }

        /// <summary>
        ///     Check whether SDK has already been configured or not.
        /// </summary>
        public static bool Configured => AppCenterInternal.IsConfigured();

        public static void SetWrapperSdk()
        {
            AppCenterInternal.SetWrapperSdk(WrapperSdk.WrapperSdkVersion, WrapperSdk.Name,
        ...
        {
            if (_secretTask == null) _secretTask = new AppCenterTask<string>();
            return _secretTask;
        }
        ...
        public static string ParseAndSaveSecretForPlatform(string secrets)
        {
            ...
            if (!secrets.Contains("=")) return secrets;
            ...
            if (_secretTask != null) _secretTask.SetResult(platformSecret);
        ...
        public static Type Analytics => AppCenterAssembly.GetType("Microsoft.AppCenter.Unity.Analytics.Analytics");

        public static Type Crashes => AppCenterAssembly.GetType("Microsoft.AppCenter.Unity.Crashes.Crashes");

        public static Type Distribute => AppCenterAssembly.GetType("Microsoft.AppCenter.Unity.Distribute.Distribute");
