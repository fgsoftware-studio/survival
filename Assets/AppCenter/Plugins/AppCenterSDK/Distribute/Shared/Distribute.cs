...
namespace Microsoft.AppCenter.Unity.Distribute
{
    ...
    public class Distribute
    {
        ...
        public static WillExitAppCallback WillExitApp { get; set; }

        /// <summary>
        ///     Sets the no release available callback.
        /// </summary>
        /// <value>The no release available callback.</value>
        public static NoReleaseAvailableCallback NoReleaseAvailable { get; set; }
        ...
        ///     Update action. On mandatory update, you can only pass <see cref="UpdateAction.Update" />
        /// </param>
