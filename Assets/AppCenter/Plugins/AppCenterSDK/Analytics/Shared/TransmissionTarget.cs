...
namespace Microsoft.AppCenter.Unity.Analytics
{
    ...
    public class TransmissionTarget
    {
        ...
        public TransmissionTarget(object rawObject)
        {
        ...
        {
            if (string.IsNullOrEmpty(childTransmissionTargetToken)) return null;
            bool success;
            var internalObject =
                TransmissionTargetInternal.GetTransmissionTarget(_rawObject, childTransmissionTargetToken, out success);
