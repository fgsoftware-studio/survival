...
{
    [AppSecret("iOS App Secret")] public string iOSAppSecret = "";

    [AppSecret] public string AndroidAppSecret = "";

    [AppSecret] public string UWPAppSecret = "";
    ...
    [Tooltip(
        "App Center Distribute will let your users install a new version of the app when you distribute it via the App Center.")]
    ...
    [Tooltip(
        "By default, App Center Distribute checks for update at application startup automatically. Uncheck this to check for updates manually instead.")]
    ...
    [CustomDropDownProperty("Public", 1)] [CustomDropDownProperty("Private", 2)]
    ...
    public Type[] Services
    {
        get
        {
            ...
            if (UseAnalytics) services.Add(AppCenter.Analytics);
            if (UseCrashes) services.Add(AppCenter.Crashes);
            if (UseDistribute) services.Add(AppCenter.Distribute);
