...
public class AppCenterBehavior : MonoBehaviour
{
    ...
    private void StartAppCenter()
    {
        ...
        if (Settings.CustomLogUrl.UseCustomUrl) AppCenter.CacheLogUrl(Settings.CustomLogUrl.Url);
        ...
        if (IsStartFromAppCenterBehavior(advancedSettings))
        {
            ...
            if (Settings.EnableManualSessionTracker) Analytics.EnableManualSessionTracker();
            if (Settings.CustomLogUrl.UseCustomUrl) AppCenter.SetLogUrl(Settings.CustomLogUrl.Url);
    ...
    {
        if (InitializingServices != null) InitializingServices.Invoke();
    }

    private static void InvokeInitializedServices()
    {
        if (InitializedAppCenterAndServices != null) InitializedAppCenterAndServices.Invoke();
    }
}